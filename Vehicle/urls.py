...
from .views import (ParkingLotInfoView, PrebookView, VehicleListview, Faqview, VehicleCreateview, AboutView, submit_feedback, admin_feedback, Contactview)
...
urlpatterns = [
    ...
    path('prebook/<int:pk>/update/', PrebookUpdateView.as_view(), name='prebook-update'),
    path('prebook/<int:pk>/delete/', PrebookDeleteView.as_view(), name='prebook-delete'),
